...
class MyTest(unittest.TestCase):
    ...
    def test_01(self):
        ...
        updateModelProfileByKeyUsingPOST = request_frame_work.request1(updateModelProfileByKeyUsingPOST_url, headers1, updata_param2, typed="post")
        ...
        """删除优模型"""
        deleteModelProfileByKeyUsingPOST_url = jh_url + "/modelAdmin/delete"
        deleteModelProfileByKeyUsingPOST = request_frame_work.request1(deleteModelProfileByKeyUsingPOST_url, headers1, getmodel_param2, typed="post")
